var locale_de = {
    ...
    docElementUserEditable: 'Vom Benutzer bearbeitbar',
    ...
    menuInsertReportTip: 'Vorlage einfügen',
    menuLogReport: 'LOG',
    menuLogReportTip: 'Vorlage in Konsole ausgeben',
    menuPreview: 'VORSCHAU',
    menuPreviewTip: 'Vorschau',
    menuRedo: 'WIEDERH.',
    ...
    menuSave: 'SPEICHERN',
    menuSaveTip: 'Speichern',
    menuSetting: 'Einstellungen',
    menuSettingTip: 'Berichtseinstellung',
    menuToggleMenu: 'Umschalten',
    menuToggleMenuTip: 'Menü umschalten',
    menuToggleFullscreen: 'Vollbild',
    menuToggleFullscreenTip: 'Vollbild umschalten',
    ...
    parameterUserEditable: 'Vom Benutzer bearbeitbar',
